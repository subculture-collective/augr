...
export function PolymarketPage() {
  ...
  useEffect(() => { if (wsStatus === 'open') sendCommand({ action: 'subscribe_polymarket' }) }, [sendCommand, wsStatus])
