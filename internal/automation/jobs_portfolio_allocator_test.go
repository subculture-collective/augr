...
type portfolioAllocatorSnapshotStub struct{ snapshot portfolio.AccountSnapshot }

func (s portfolioAllocatorSnapshotStub) CaptureAccountSnapshot(context.Context) (portfolio.AccountSnapshot, error) {
