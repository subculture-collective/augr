...
func TestCatalogCoversEveryRegisteredAutomationJob(t *testing.T) {
	...
	for _, conditional := range []string{"generated_proposal", "generated_research_prepare", "generated_research", "generated_evaluation", "generated_robustness", "generated_deployment", "promotion_evaluation", "promotion_activation"} {
